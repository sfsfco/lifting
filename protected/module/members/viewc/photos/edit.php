			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="x_content">
						...
						<form class="form-horizontal form-label-left"  method="post" action="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>photos/update/<?php echo $data['photo']->id; ?>"  enctype='multipart/form-data'  novalidate>
						<?php play::display_message(); ?>
							<div class="item form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Name <span class="required">*</span>
								</label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input id="name" class="form-control col-md-7 col-xs-12" value="<?php echo $data['photo']->name; ?>"  name="name" placeholder="" required="required" type="text">
								</div>
							</div>
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input id="ar_name" class="form-control col-md-7 col-xs-12" name="ar_name" value="<?php echo $data['photo']->ar_name; ?>" placeholder="" required="required" type="text">
								</div>
							</div>
							<div class="item form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="gallery">Gallery <span class="required">*</span>
								</label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<select name="gallery" id="gallery" class="select2_group form-control" >
                                    <option value="">Select</option>
                                    <?php foreach($data['galleries'] as $ga){ ?>
                                        <option value="<?php echo $ga->id; ?>" <?php if($ga->id==$data['photo']->gallery) echo "selected='selected'"?>><?php echo $ga->name; ?></option>
                                    <?php }?>
                                    </select>
								</div>
							</div>
							<div class="item form-group">
								...
								<div class="col-md-9 col-sm-9 col-xs-12">
									<div class="x_content">
					                  ...
					                  <div id="editor-one" class="editor-wrapper"><?php echo $data['photo']->details; ?></div>
							...
							<div class="item form-group">
								...
								<div class="col-md-9 col-sm-9 col-xs-12">
									<div class="x_content">
					                  ...
					                  <div id="ar_editor-one" class="editor-wrapper"><?php echo $data['photo']->ar_details; ?></div>
							...
							<?php $photo_arr=explode(',',$data['photo']->photo); ?>
							<div class="item form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Photo <span class="required">*</span>
								</label>
								<div class="col-md-9 col-sm-9 col-xs-12">
									<div class="col-md-12 col-sm-12 col-xs-12">
										<?php foreach($photo_arr as $ph){ ?>
											<div class="photo-frame">
											<i class="fa fa-trash-o fa-2" aria-hidden="true" img-val=<?php echo $ph; ?> ></i>
											<img src='<?php echo Doo::conf()->APP_URL; ?>global/uploads/photos/300X300_<?php echo $ph; ?>.jpg' />
											</div>
										<?php } ?>
										<br>
										<br>
							...
							<div class="form-group">
								<div class="col-md-6 col-md-offset-3">
									<input type="hidden" name="old_photos" id="old_photos" />
	...
	$( document ).ready(function() {
	    $('.fa-trash-o').click(function(event) {
		    if (confirm("Remove This Image!") == true) {
			    img = $(this).attr('img-val');
		    	$('#old_photos').val($('#old_photos').val()+','+img);
		    	$(this).parent('.photo-frame').attr('style', 'display:none');    
		    } 

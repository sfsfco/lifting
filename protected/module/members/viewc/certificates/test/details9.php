 ...
 <body>
    <div class="container showgrid">
        ...
        <!--start print-->
            ...
            <div class="span-10" style="height:20px">QUALIFICATION: <b>ASNT LEVEL TWO</b> </div><div class="span-10 last" style="height:20px">DATE OF TEST/EXAMINATION: <b><?php echo $data['cert']->next_examination; ?></b></div>
            <div class="span-10">TYPE OF CERTIFICATE: <b>NDT REPORT</b> </div><div class="span-10 last">TESTED ACCORDING TO <b><?php echo $data['cert']->according_to; ?></b></div>
            <div class="span-20 last center">
                <table class="pclass">
                    <thead> 
                        <tr> 

...
<script type="text/javascript" src="<?php  echo $data['rootUrl']; ?>global/js/jquery.printElement.js"></script>
 ...
 <body>
    <div class="container showgrid">
        <div class="span-20 push-2  last printable result" style="text-align:left;direction:ltr;height:1120px;display:inline-block;margin-left:-40px;">
        <!--start print-->
            ...
            <div class="span-12" >
                <h2 style="padding-top: 15px;font-weight: bolder;font-size: 1.5em;margin-bottom: 2px;">REPORT OF THOROUGH EXAMINATION</h2>
                <h2 style="padding-top: 0px;font-weight: bolder;font-size: 1.5em;margin-bottom: 0px;">AND / OR TEST OF LIFTING APPLIANCE OR ACCESSORY</h2>
            </div>
            ...
            <div class="span-20 last center" style="margin-bottom:10px;">
            ...
            <div class="span-10" style="height:20px">CERTIFICATION NO: <b><?php echo $data['cert']->id; ?></b></div><div class="span-10 last" style="height:20px">TESTER/EXAMINER: ENG. <b><?php echo $data['quotation']->create_by_name;?></b></div>
            <div class="span-10" style="height:20px">QUALIFICATION: <b>ASNT LEVEL TWO</b></div><div class="span-10 last" style="height:20px">DATE OF TEST/EXAMINATION: <b><?php echo date('d-m-Y',strtotime($data['cert']->test_date));  ?></b></div>
            <div class="span-10" >TYPE OF CERTIFICATE:  <b>VISUAL AND MPI CERTIFICATE</b> </div><div class="span-10 last" >TESTED ACCORDING TO <b><?php echo $data['cert']->according_to; ?></b></div>
            <div class="span-20 last center">
                <table class="pclass">
                    <thead> 
                        <tr> 
            ...
            <div class="span-20 last ">
                <table class="pclass1">
                    ...
                    <tbody> 
                        <tr>
                            <td>Procedure: QP9.5</td><td>Equipment: PERMANENT MAGNET</td><td>Method: WET</td>
                        </tr>
                        <tr>
                            <td>Specification: BSEN1290:1998</td><td>Contrast Media: NPT16 WHITE PAINT</td><td>Inspector: <?php echo $data['user']->first_name.' '.$data['user']->last_name;?></td>
                        </tr>
                         <tr>
                            <td>Material: CARBON STEEL</td><td>Indicator: BLACK INK</td><td>Qualification: ASNT II</td>
                        </tr>
                         <tr>
                            <td colspan="3"  style="font-size: 0.8em;" >
                                Results: 100% MAGNETIC PARTICAL INSPECTION WAS CARRIED OUT ON THE LIFTING POINTS WELDS OF THE ABOVE EQUIPMENT. NO INDICATIONS WERE NOTED AT THE TIME OF INSPECTION.  
                            </td>
                        </tr>
                    </tbody> 
                </table>
            ...
            <div class="span-20 last center">
                <table class="pclass">
                    ...
                    <?php $x=0; foreach($data['quotationsdetails'] as $quotationsdetails){ ?>
                        <tr>
                            <td><?php echo $quotationsdetails->original_cert_no; ?></td>
                            <td><?php echo date('d/m/Y',strtotime($quotationsdetails->original_cert_date)); ?></td>
                            <td><?php echo $quotationsdetails->name_cert; ?></td>
                            <td><?php echo date('d/m/Y',strtotime($quotationsdetails->last_exam)); ?></td>
                        </tr>                    
                    <?php } ?>
                    </tbody> 
                </table>
            ...
            <div class="span-20 last"  style="font-size: 0.8em;">
            <h4 style="font-weight: bolder;margin-bottom:0px;">The above report was compiled in accordance with the Lifting Operations and Lifting Regulations 1998, Regulation 9 (3) (a).</h4>
            ...
            <div class="span-20 last" style="padding-top:0px;">AUTHORISED SIGNATURE………...................<?php if(isset($_SESSION['member_username']['sign'])){ ?><img src="<?php  echo $data['rootUrl']; ?>global/uploads/users/<?php echo $_SESSION['member_username']['sign']; ?>" style="width:100px;"><?php } ?>........................</div>
...
<div  style="text-align: center;display: block;z-index: 999;position: fixed;top: 50%;right: 120px;">
    <a onclick="printit('REPORT OF THOROUGH EXAMINATION')" style="cursor:pointer;position: absolute;"><img src="<?php  echo $data['rootUrl']; ?>global/img/printl.png" title="Print" alt="Print" ></a>
</div>

 ...
 <link rel="stylesheet" href="<?php  echo $data['rootUrl']; ?>global/css/my.css" type="text/css" media="screen, projection,print">
    ...
    <div class="container showgrid">
        ...
        <!--start print-->
            ...
            <div class="span-12" >
                <h2 style="padding-top: 20px;font-weight: bolder;">TEST CERTIFICATE</h2>
            </div>
...
<div style="width:100%;text-align:center;dispay:inline-block;">
    <a onclick="printit('TEST CERTIFICATE')" style="cursor:pointer;"><img src="<?php  echo $data['rootUrl']; ?>global/img/printl.png" title="Print" alt="Print" ></a>
</div>

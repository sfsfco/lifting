...
<script type="text/javascript" src="<?php  echo $data['rootUrl']; ?>global/js/jquery.printElement.js"></script>
 ...
 <body>
    <div class="container showgrid">
        <div class="span-20 push-2    last printable result" style="text-align:left;direction:ltr;min-height:1120px;display:inline-block;">
        <!--start print-->
            ...
            <div class="span-12" >
                <h2  class='report-header'>VISUAL CERTIFICATE</h2>
            </div>
            ...
            <div class="span-20 last center" style="margin-bottom:0px;">
            ...
            <div class="span-10" style="height:35px">CERTIFICATION NO: <b><?php echo $data['cert']->id; ?></b></div><div class="span-10 last" style="height:35px">TESTER/EXAMINER: ENG. <b><?php echo $data['quotation']->create_by_name;?></b></div>
            <div class="span-10" style="height:35px">QUALIFICATION: <b>ASNT LEVEL TWO </b></div><div class="span-10 last" style="height:35px">DATE OF TEST/EXAMINATION: <b><?php echo date('d-m-Y',strtotime($data['cert']->test_date));  ?></b></div>
            <div class="span-10">TYPE OF CERTIFICATE:  <b>VISUAL CERTIFICATE </b></div><div class="span-10 last" >TESTED ACCORDING TO <b><?php echo $data['cert']->according_to; ?></b></div>
            ...
            <div class="span-20 last" style="padding-top:40px;">AUTHORISED SIGNATURE………..................<?php if(isset($_SESSION['member_username']['sign'])){ ?><img src="<?php  echo $data['rootUrl']; ?>global/uploads/users/<?php echo $_SESSION['member_username']['sign']; ?>" style="width: 150px;position: absolute;margin-top: -20px;margin-left: -75px;"><?php } ?>.........................  <img style="position: absolute;right: 120px;margin-top: -56px;height:105px;" src="<?php echo $data['rootUrl']; ?>global/images/stamp.png"></div>
...
<div style="width:100%;text-align:center;display:inline-block;">
    <a onclick="printit('visual certificate')" style="cursor:pointer;"><img src="<?php  echo $data['rootUrl']; ?>global/img/printl.png" title="Print" alt="Print" ></a>
</div>

 ...
 <body>
    <div class="container showgrid">
        ...
        <!--start print-->
            ...
            <div class="span-20 last center" style="margin-bottom:5px;">
            ...
            <div class="span-10" style="height:15px">CERTIFICATION NO: <b><?php echo $data['cert']->id; ?></b></div><div class="span-10 last" style="height:15px">TESTER/EXAMINER: ENG. <b><?php echo $data['quotation']->create_by_name;?></b></div>
            <div class="span-10" style="height:15px">QUALIFICATION: <b>ASNT LEVEL TWO </b></div><div class="span-10 last" style="height:15px">DATE OF TEST/EXAMINATION: <b><?php echo date('d-m-Y',strtotime($data['cert']->test_date));  ?></b></div>
            <div class="span-10">TYPE OF CERTIFICATE:  <b>VISUAL AND DPI CERTIFICATE</b> </div><div class="span-10 last" >TESTED ACCORDING TO <b><?php echo $data['cert']->according_to; ?></b></div>
            <div class="span-20 last center">
                <table class="pclass">
                    <thead> 
                        <tr> 
...
<div class="span-20 last ">
            ...
            <div class="span-20 last" style="padding-top:5px;">AUTHORISED SIGNATURE………....................<?php if(isset($_SESSION['member_username']['sign'])){ ?><img src="<?php  echo $data['rootUrl']; ?>global/uploads/users/<?php echo $_SESSION['member_username']['sign']; ?>" style="width:100px;"><?php } ?>.......................</div>

 ...
 <link rel="stylesheet" href="<?php  echo $data['rootUrl']; ?>global/css/my.css" type="text/css" media="screen, projection,print">
    ...
    <div class="container showgrid">
        ...
        <!--start print-->
            ...
            <div class="span-12" >
                <h2 style="padding-top: 20px;font-weight: bolder;">TEST AND MPI CERTIFICATE</h2>
            </div>
            ...
            <div class="span-20 last center" style="margin-bottom:15px;">
                <h2 style="padding-top: 0px;font-weight: bolder;">AND / OR TEST OF LIFTING APPLIANCE OR ACCESSORY</h2>
            ...
            <div class="span-10" >TYPE OF CERTIFICATE: <b>LOAD TEST/ MPI  </b></div><div class="span-10 last" >TESTED ACCORDING TO <b><?php echo $data['cert']->according_to; ?></b></div>
            <div class="span-20 last center">
                <table class="pclass">
                    <thead> 
                        <tr> 
            ...
            <div class="span-20 last ">
                <table class="pclass1">
                    ...
                    <tbody> 
                        ...
                        <tr>
                            <td>Specification: BSEN1290:1998</td><td>Contrast Media: NPT16 WHITE PAINT</td><td>Inspector: <?php echo(isset($data['user']->first_name))?$data['user']->first_name.' '.$data['user']->last_name:'deleted';?></td>
                        </tr>
                         <tr>

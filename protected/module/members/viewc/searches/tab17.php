...
<table id="myTable" class="tablesorter"> 
            ...
            <tbody> 
                ...
                <tr class="table-row<?php echo $x%2; ?>">
                    <td><a id="del_<?php echo $purchase->id; ?>"  href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->membermod; ?>good/delete/<?php echo $purchase->id; ?>" class="delet">
                            <img src="<?php  echo $data['rootUrl']; ?>global/img/delete.gif" >
                        </a></td>
                    <td><?php echo $purchase->by; ?></td>
                    
                     <td>
                        <a  href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->membermod; ?>good/details/<?php echo $purchase->id; ?>" class="link">

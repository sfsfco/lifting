...
<table id="myTable" class="tablesorter"> 
            ...
            <tbody> 
                <?php $x=0; if(!empty($data['workorders'])){foreach($data['workorders'] as $workorder){ ?>
                <tr class="table-row<?php echo $x%2; ?> " >
                      <td>
                        <a id="del_<?php echo $workorder->id; ?>"    href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->membermod; ?>workorders/delete/<?php echo $workorder->id; ?>" class="delet">
                    ...
                    <td>
                     ...
                     <td>
                        <a  href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->membermod; ?>workorders/details/<?php echo $workorder->id; ?>" class="link">
                    ...
                    <td><a href="<?php echo $data['formUrl']; ?><?php echo Doo::conf()->membermod; ?>workorders/edit/<?php echo $workorder->id; ?>" class="link" ><?php echo $workorder->title; ?></a></td>

...
<table id="myTable" class="tablesorter"> 
            ...
            <tbody> 
                ...
                <tr class="table-row<?php echo $x%2; ?> " >
                      <td>
                        <a id="del_<?php echo $stockallocation->id; ?>"    href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->membermod; ?>stockallocations/delete/<?php echo $stockallocation->id; ?>" class="delet">
                    ...
                    <td>
                        <a href="<?php echo $data['formUrl']; ?><?php echo Doo::conf()->membermod; ?>stockallocations/edit/<?php echo $stockallocation->id; ?>" class="link" >

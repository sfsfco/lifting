<table id="myTable" class="tablesorter"> 
            ...
            <tbody> 
                ...
                <tr class="table-row<?php echo $x%2; ?>">
                    <td>
                        <a id="del_<?php echo $contact->id; ?>"  href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->membermod; ?>contact/delete/<?php echo $contact->id; ?>" class="delet">
                  ...
                  <td style="text-align:center">
                    ...
                    <td><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->membermod; ?>contact/read/<?php echo $contact->id;?>" class="link"><?php echo $contact->subject ; ?></a></td>

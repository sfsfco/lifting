...
<html lang="en">
  <head>
    ...
    <title><?php echo play::prefrances('site_name'); ?> | Login</title>

    <!-- Bootstrap -->
    <link href="<?php echo Doo::conf()->APP_URL; ?>global/admin/vendors/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
    <!-- Font Awesome -->
    <link href="<?php echo Doo::conf()->APP_URL; ?>global/admin/vendors/font-awesome/css/font-awesome.min.css" rel="stylesheet">
    <!-- NProgress -->
    <link href="<?php echo Doo::conf()->APP_URL; ?>global/admin/vendors/nprogress/nprogress.css" rel="stylesheet">
    <!-- Animate.css -->
    <link href="<?php echo Doo::conf()->APP_URL; ?>global/admin/vendors/animate.css/animate.min.css" rel="stylesheet">

    <!-- Custom Theme Style -->
    <link href="<?php echo Doo::conf()->APP_URL; ?>global/admin/build/css/custom.min.css" rel="stylesheet">
    <style type="text/css">
    	.dooFlashMessenger_flashm{display: inline-block;font-size: 16px;
    font-weight: 200;
    color: #FFF;}
    </style>
  </head>
  ...
  <body class="login">
      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
          <section class="login_content">
            <form  name="form_login" method="post" action="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>login/login" >
              <h1>Login Form</h1>
    ...
    <!-- PNotify -->
    <script src="<?php echo Doo::conf()->APP_URL; ?>global/admin/vendors/pnotify/dist/pnotify.js"></script>
    <script src="<?php echo Doo::conf()->APP_URL; ?>global/admin/vendors/pnotify/dist/pnotify.buttons.js"></script>
    <script src="<?php echo Doo::conf()->APP_URL; ?>global/admin/vendors/pnotify/dist/pnotify.nonblock.js"></script>

...
<!-- /TinyMCE -->
 ...
 $('.cert_type').change(function(){
  ...
  $.ajax({
        url: '<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>certificates/index/'+$(this).val(),
        cache: false,
...
$('textarea.tinymce').tinymce({
    ...
    $( "#tabs" ).tabs();
        ...
        $('#filter-stockroom').change(function(){
             $.ajax({
      url: '<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>stores/filter/'+$(this).val(),
      cache: false,
      success: function(html){
        $(".place").html(html);
        beready();
        ...
        $('#payment_for2').change(function(){
            $.ajax({
      url: '<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>returned/getpaymentid/'+$(this).val()+'/'+ $('#payment_type').val(),
      cache: false,
      success: function(html){
        ...
        $('#payment_id2').change(function(){
            $.ajax({
      url: '<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>returned/getpaymentdetails/'+$(this).val(),
      cache: false,
      success: function(html){
        ...
        $('#payment_for1').change(function(){
            $.ajax({
      url: '<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>payments/getpaymentid1/'+$(this).val()+'/'+ $('#payment_type1').val(),
      cache: false,
      success: function(html){$('#payment_id1').html(html);}
        ...
        $.ajax({
      url: '<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>payments/paymenttype1/'+$(this).val(),
      cache: false,
      success: function(html){$('#payment_for1').html(html);}
        ...
        $('#payment_for').change(function(){
            $.ajax({
      url: '<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>payments/getpaymentid/'+$(this).val()+'/'+ $('#payment_type').val(),
      cache: false,
      success: function(html){
        ...
        $.ajax({
      url: '<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>payments/paymenttype/'+$(this).val(),
      cache: false,
      success: function(html){
    ...
    $('#username').keyup(function(){
         ...
         $.ajax({
      url: "<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>users/checkusername/"+$(this).val(), 
      cache: false,
      success: function(html){
...
///search
 $(".search-button").click(function(){
           ...
           $(".place").html('<div style="padding-top:30px;width:100%;text-align:center;background:#FFF"><img src="<?php  echo Doo::conf()->APP_URL; ?>global/img/ajax-13.gif" /></div>');
            setTimeout(function(){
            $.ajax({
      url:'<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>searches/find/', 
      cache: false,
          type:'post',
          data:$values,
      success: function(html){
    ...
    (
      {
                ...
                url:'<?php  echo $data['formUrl']; ?><?php echo Doo::conf()->membermod; ?>'+type+'/uploadimg/'+name,
        secureuri:false,
        fileElementId:id,
        dataType: 'json',
...
function get_delivery(v){
     $.ajax({
      url: '<?php echo $data['formUrl']; ?><?php echo Doo::conf()->membermod; ?>invoices/getitems/'+v, 
      cache: false,
      success: function(html){
...
function getpurchase(v){
     $.ajax({
      url: '<?php echo $data['formUrl']; ?><?php echo Doo::conf()->membermod; ?>good/getpurchase/'+v, 
      cache: false,
      success: function(html){
             $('#options-table').html(html.split('#')[0]);
  ...
  <body>
     ...
     <div class="span-16 ">
        <div style="float:left;text-align:center;">
            <a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>"><img class="site-logo"  src="<?php  echo Doo::conf()->APP_URL; ?>global/uploads/<?php echo play::prefrances('logo'); ?>" ></a>
      ...
      <div class="span-24 last" style="direction:ltr">
        ...
        &nbsp;&nbsp;|&nbsp;&nbsp;<a  href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>users/edit/<?php echo  $_SESSION['member_username']['id']; ?>" class="link">My Account </a>
        &nbsp;&nbsp;|&nbsp;&nbsp;<a  href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>users/editpass/<?php echo $_SESSION['member_username']['id']; ?>" class="link">Change Password</a>
        &nbsp;&nbsp;|&nbsp;&nbsp;<a href="<?php  echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>login/logout"><span style="color:red">Logout</span></a> 
      ...
      <div class="span-24 last">
        <div class="borderhard" style="margin-top:30px;text-align:center;">
                <ul class="sf-menu">
                        <li class="last"><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>searches">Search<img src="<?php  echo Doo::conf()->APP_URL; ?>global/img/icons/search.png"></a></li>
            <li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>prefrances" >Prefrances<img src="<?php  echo Doo::conf()->APP_URL; ?>global/img/icons/prefrance.png"></a></li>
                        <li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>reports">Reports<img src="<?php  echo Doo::conf()->APP_URL; ?>global/img/icons/report.png"></a></li>
                        <li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>quotations">Quotations <img src="<?php  echo Doo::conf()->APP_URL; ?>global/img/icons/daily.png"></a></li>
                        <li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>workorders">Work Orders <img src="<?php  echo Doo::conf()->APP_URL; ?>global/img/icons/daily.png"></a>
                        <ul>
                            <li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>workorders">Work Orders <img src="<?php  echo Doo::conf()->APP_URL; ?>global/img/icons/daily.png"></a></li>
                            <li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>certificates">Certificates <img src="<?php  echo Doo::conf()->APP_URL; ?>global/img/icons/daily.png"></a></li>
                            <li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>delivery">Delivery Note <img src="<?php  echo Doo::conf()->APP_URL; ?>global/img/icons/daily.png"></a></li>
                            
                        </ul>
                        </li>
                        <li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>purchases">Purchases<img src="<?php  echo Doo::conf()->APP_URL; ?>global/img/icons/daily.png"></a></li>
                        <!--
                        <li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>returned">Refund<img src="<?php  echo Doo::conf()->APP_URL; ?>global/img/icons/daily.png"></a></li>
                        -->
                        <li>Accounts<img  src="<?php  echo Doo::conf()->APP_URL; ?>global/img/icons/daily.png">
                            <ul>
                                <!--<li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>expenses">Expenses</a></li>-->
                                <li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>banks">Our Bank Accounts</a></li>
                                <li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>invoices">Invoices</a></li>
                                <!--<li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>payments/income">Income Check</a></li>
                                <li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>payments/pay">Payment Check</a></li>-->
                            </ul>
                        </li>
                        <li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>stockrooms">Stores<img src="<?php  echo Doo::conf()->APP_URL; ?>global/img/icons/item.png"></a>
                        <ul>
                                        <li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>stockrooms">Stores</a></li>
                                        <li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>items">Items</a></li>
                                        <li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>stores">Stores Stock</a></li>
                                        <li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>stockallocations">Stock Allocation</a></li>
                                        <li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>good">Goods Receipts Note</a></li>
                                    </ul>
                        </li>
                        
                       
                        <li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>users">Settings<img src="<?php  echo Doo::conf()->APP_URL; ?>global/img/icons/tool.png"></a>
                        <ul>
                            <li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>users" >Users</a></li>
                            <li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>groups" >Groups</a></li>
                            <li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>clients">Clients</a></li>
                            <li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>suppliers">Suppliers</a></li>
                            <!--<li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>towns">Towns</a></li>-->
                            <li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>otherbanks">Banks</a></li>
                            <li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>categories">Categories</a></li>
                        </ul>
                        </li>
                        <li class="first"><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>articles">CMS<img src="<?php  echo Doo::conf()->APP_URL; ?>global/img/icons/edit.png"></a>
                        <ul>
                            <li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>articles">Articles</a></li>
                            <li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>services">Services</a></li>
                            <li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>photos">Photos</a></li>
                            <li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>contact">Messages</a></li>
                            <li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>inspaction">Inspections Request</a></li>
                            <li><a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>maillist">maillist</a></li>
                        </ul>
                        </li>
                    </ul>
        </div>

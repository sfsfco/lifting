			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="x_content">
						...
						<form class="form-horizontal form-label-left"  method="post" action="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>products/update/<?php echo $data['product']->id; ?>"  enctype='multipart/form-data'  novalidate>
						<?php play::display_message(); ?>
							<div class="item form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Name <span class="required">*</span>
								</label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input id="name" class="form-control col-md-7 col-xs-12" value="<?php echo $data['product']->name; ?>"  name="name" placeholder="" required="required" type="text">
								</div>
							</div>
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input id="ar_name" class="form-control col-md-7 col-xs-12" name="ar_name" value="<?php echo $data['product']->ar_name; ?>" placeholder="" required="required" type="text">
								</div>
							</div>
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <?php foreach($data['productcategories'] as $ga){ ?>
                                        <option value="<?php echo $ga->id; ?>" <?php if($ga->id==$data['product']->product_category) echo "selected='selected'"?>><?php echo $ga->name; ?></option>
                                    <?php }?>
                                    </select>
								</div>
							</div>
							<div class="item form-group">
								...
								<div class="col-md-9 col-sm-9 col-xs-12">
									<div class="x_content">
					                  ...
					                  <div id="editor-one" class="editor-wrapper"><?php echo $data['product']->details; ?></div>
							...
							<div class="item form-group">
								...
								<div class="col-md-9 col-sm-9 col-xs-12">
									<div class="x_content">
					                  ...
					                  <div id="ar_editor-one" class="editor-wrapper"><?php echo $data['product']->ar_details; ?></div>
							...
							<?php $photo_arr=explode(',',$data['product']->photo); ?>
							<div class="item form-group">
								...
								<div class="col-md-9 col-sm-9 col-xs-12">
									<div class="col-md-12 col-sm-12 col-xs-12">
										<?php foreach($photo_arr as $ph){ ?>
											...
											<img src='<?php echo Doo::conf()->APP_URL; ?>global/uploads/products/300X300_<?php echo $ph; ?>.jpg' />
											</div>
										<?php } ?>
										<br>
										<br>
	...
	$( document ).ready(function() {
	    $('.fa-trash-o').click(function(event) {
		    if (confirm("Remove This Image!") == true) {
		    	...
		    	$('#old_products').val($('#old_products').val()+','+img);
		    	$(this).parent('.product-frame').attr('style', 'display:none');    
		    } 

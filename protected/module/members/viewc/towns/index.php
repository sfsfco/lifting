...
<div class="span-23 last" style="padding-top:10px;text-align:left;font-size:20px;">
    ...
    <a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->membermod; ?>towns/add" class="link">
       <h4 style="margin:0px;">
...
<table id="myTable" class="tablesorter"> 
            ...
            <tbody> 
                ...
                <tr class="table-row<?php echo $x%2; ?>">
                    <td>
                        <a id="del_<?php echo $town->id; ?>"  href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->membermod; ?>towns/delete/<?php echo $town->id; ?>" class="delet">
                            <img src="<?php  echo $data['rootUrl']; ?>global/img/delete.gif" >
                        </a>
                    </td>
                    <td>
                        <a  href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->membermod; ?>towns/edit/<?php echo $town->id; ?>" class="link">
                            <?php echo $town->name; ?>
                        </a>
                    </td>

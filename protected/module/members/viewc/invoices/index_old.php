...
<div class="span-23 last" style="padding-top:10px;text-align:left;font-size:20px;">
    ...
    <a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->membermod; ?>invoices/add" class="link">
        <h4 style="margin:0px;">
            ...
            <tbody> 
                ...
                <tr class="table-row<?php echo $x%2; ?>" >
                    <td>
                        ...
                        <a id="del_<?php echo $invoice->id; ?>"    href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->membermod; ?>invoices/delete/<?php echo $invoice->id; ?>" class="delet">
                        ...
                        <td>
                       <a  href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->membermod; ?>invoices/details/<?php echo $invoice->id; ?>" target="_blank">

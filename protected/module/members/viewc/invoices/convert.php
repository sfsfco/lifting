...
<form name="form" id="form" action="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->membermod; ?>quotations/convertnow" method="post">
...
<div class="span-9 ">Purchase Order No.</div>
<div class="span-15 last"><input type="text" name="po_no" id="po_no"  class="required" value=""></div>

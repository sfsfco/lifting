...
<!-- /TinyMCE -->
 ...
 $('.cert_type').change(function(){
  ...
  $.ajax({
        url: '<?php echo $data['formUrl'] ?><?php echo Doo::conf()->membermod; ?>certificates/index/'+$(this).val(),
        cache: false,
            		...
            		<ul class="sf-menu">
                        ...
                        <li>Accounts<img  src="<?php  echo $data['rootUrl']; ?>global/img/icons/daily.png">
                            <ul>
                                ...
                                <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->membermod; ?>invoices">Invoices</a></li>
                        ...
                        <ul>
                                        ...
                                        <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->membermod; ?>stockallocations">Stock Allocation</a></li>
                                        <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->membermod; ?>good">Goods Receipts Note</a></li>
                                    </ul>
                        </li>
                        ...
                        <ul>
                            ...
                            <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->membermod; ?>services">Services</a></li>
                            ...
                            <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->membermod; ?>inspaction">Inspections Request</a></li>

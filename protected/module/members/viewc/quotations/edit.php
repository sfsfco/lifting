            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left"  method="post" action="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>quotations/update/<?php echo $data['quotation']->id; ?>"  novalidate>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input class="form-control col-md-7 col-xs-12" name="title" id="title" value="<?php echo $data['quotation']->title; ?>" type="text" >
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <?php foreach($data['clients'] as $client){ ?>
                                        <option value="<?php echo $client->id; ?>" <?php echo($data['quotation']->client==$client->id)?"selected='selected'":""; ?>><?php echo $client->name; ?></option>
                                    <?php }?>
                                    </select>
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input class="form-control col-md-7 col-xs-12" name="request_no" id="request_no" value="<?php echo $data['quotation']->request_no; ?>" type="text" >
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" class="form-control has-feedback-left datepicker" name="quotation_date" id="quotation_date" aria-describedby="inputSuccess2Status4" value="<?php echo date('Y-m-d',strtotime($data['quotation']->quotation_date)); ?>">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" class="form-control has-feedback-left datepicker" name="delivery_date" id="delivery_date" aria-describedby="inputSuccess2Status4" value="<?php echo date('Y-m-d',strtotime($data['quotation']->delivery_date)); ?>">
                                        <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="options-table col-md-9 col-sm-9 col-xs-12">
                                    ...
                                    <div class=" <?php if($x==0){echo('first');} ?> options-table-item col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-md-1 col-sm-1 col-xs-12">
                                            <input name="quantity_<?php echo $x; ?>" id="quantity_<?php echo $x; ?>" class="form-control col-md-7 col-xs-12"  required="required" type="text" onkeyup="updatebill(this);" onchange="updatebill(this);"   value="<?php  echo $quotationsdetails->quantity; ?>">
                                        </div>
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <textarea name="details_<?php echo $x; ?>" id="details_<?php echo $x; ?>" class="form-control"><?php  echo $quotationsdetails->details; ?></textarea>
                                        </div>
                                        <div class="col-md-2 col-sm-2 col-xs-12">
                                            <input id="swl_<?php echo $x; ?>" class="form-control col-md-7 col-xs-12" name="swl_<?php echo $x; ?>" placeholder="" required="required" type="text" value="<?php  echo $quotationsdetails->swl; ?>">
                                        </div>
                                        <div class="col-md-1 col-sm-1 col-xs-12">
                                            <input id="unit_cost_<?php echo $x; ?>" class="form-control col-md-7 col-xs-12"  name="unit_cost_<?php echo $x; ?>" onkeyup="updatebill(this);" onchange="updatebill(this);"  placeholder="" required="required" type="text" value="<?php  echo $quotationsdetails->unit_cost; ?>">
                                        </div>
                                        <div class="col-md-2 col-sm-2 col-xs-12">
                                            <input id="total_<?php echo $x; ?>" class="form-control col-md-7 col-xs-12" name="total_<?php echo $x; ?>" placeholder="" required="required" type="text" value="<?php  echo $quotationsdetails->total; ?>">
                                        </div>
                                        <div class="col-md-2 col-sm-2 col-xs-12">
                            ...
                            <div class="item form-group">
                             ...
                             <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input class="form-control col-md-7 col-xs-12" name="net_value" id="net_value" value="<?php echo $data['quotation']->net_value; ?>" type="number" >
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="tax" class="form-control col-md-7 col-xs-12"  onkeyup="updatebill(this);" onchange="updatebill(this);"  name="tax" required="required" type="number" value="<?php echo $data['quotation']->tax; ?>">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="total_value" class="form-control col-md-7 col-xs-12"  name="total_value" required="required" type="number" value="<?php echo $data['quotation']->total_value; ?>">
                                </div>
                            </div>

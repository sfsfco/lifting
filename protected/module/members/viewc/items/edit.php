            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left"  method="post" action="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>items/update/<?php echo $data['item']->_items__id; ?>"  novalidate>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="1" name="name" placeholder="" required="required" type="text" value="<?php echo $data['item']->_items__name; ?>">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="barcode" class="form-control col-md-7 col-xs-12" data-validate-length-range="" name="barcode" placeholder="" required="required" type="number" value="<?php echo $data['item']->barcode; ?>">
                                </div>
                            </div>
                            <div class="item form-group">
                             ...
                             <div class="item form-group">
                              ...
                              <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="order_limit" class="form-control col-md-7 col-xs-12" data-validate-length-range="1,1000000" name="order_limit" placeholder="" type="number" value="<?php echo $data['item']->order_limit; ?>">
                                    </div>
                                </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <textarea id="details" name="details" class="form-control col-md-7 col-xs-12"><?php echo $data['item']->details; ?></textarea>
                                </div>
                             </div>

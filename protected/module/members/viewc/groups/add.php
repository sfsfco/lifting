            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left"  method="post" action="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>groups/insert"  novalidate>
                             ...
                             <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <label class="control-label col-md-2 col-sm-3 col-xs-12 text-center"><div class="text-center">
                                    <input type="checkbox" class="flat" value="1"  name="<?php echo $module.'_view'?>"></div>
                                </label>
                                <label class="control-label col-md-2 col-sm-3 col-xs-12 text-center"><div class="text-center">
                                    <input type="checkbox" class="flat" value="1"  name="<?php echo $module.'_add'?>"></div>
                                </label>
                                <label class="control-label col-md-2 col-sm-3 col-xs-12 text-center"><div class="text-center">
                                    <input type="checkbox" class="flat" value="1"  name="<?php echo $module.'_update'?>"></div>
                                </label>
                                <label class="control-label col-md-2 col-sm-3 col-xs-12 text-center"><div class="text-center">
                                    <input type="checkbox" class="flat" value="1" name="<?php echo $module.'_delete'?>"></div>
                                </label>
                              </div>

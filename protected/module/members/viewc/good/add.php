            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left"  method="post" action="<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>good/insert"  novalidate>
...
<script type="text/javascript">
  ...
  function getpurchase(v){
     $.ajax({
      url: '<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>good/getpurchase/'+v, 
      cache: false,
...
function getnumber(v){
    ...
    newid=id.split('_')[1];
     ...
     $.ajax({
      url: '<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>purchases/getnumber/'+v.value, 
      cache: false,
      success: function(html){
...
function getname(v){
    ...
    newid=id.split('_')[2];
     ...
     $.ajax({
      url: '<?php echo Doo::conf()->APP_URL.Doo::conf()->membermod; ?>purchases/getnames/'+v.value, 
      cache: false,
      success: function(html){

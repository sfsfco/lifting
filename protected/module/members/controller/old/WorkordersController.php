 ...
 * @author darkredz
 */
class WorkordersController extends MembersController{
    ...
    if(isset($_GET['load'])){
      ...
      foreach ($lists as $list) {
        ...
        $info['data'][]=array(
          ...
          <a href='".Doo::conf()->APP_URL.Doo::conf()->membermod."workorders/edit/".$list->id."' ><div  class='btn btn-warning'><i class='fa fa-cog'></i> Edit</div></a> 
          <a href='".Doo::conf()->APP_URL.Doo::conf()->membermod."workorders/details/".$list->id."' ><div  class='btn btn-info'><i class='fa fa-print'></i> Details</div></a> 
          </div>"
          );
      }
    }else{
     ...
     public function update(){
        ...
        $lastinserted=$this->db()->update($quotations);
          ...
          if(!empty($lastinserted)){
            ...
            header( 'Location:'.Doo::conf()->APP_URL.Doo::conf()->membermod.'workorders' );  

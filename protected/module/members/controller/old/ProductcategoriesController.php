 ...
 * @author darkredz
 */
class ProductCategoriesController extends MembersController{
    ...
    if(isset($_GET['load'])){
      ...
      foreach ($lists as $list) {
        ...
        $info['data'][]=array(
          ...
          "<div class='text-center'><a href='".Doo::conf()->APP_URL.Doo::conf()->membermod."productcategories/edit/".$list->id."' ><div  class='btn btn-warning'><i class='fa fa-cog'></i> Edit</div></a></div>"
          );
      }
    }else{
         $info['data'][]=array("","","","","","","","");
...
$this->renderc('productcategories/index',$data);
 ...
 public function edit(){
    ...
    public function update(){
      ...
      if(!empty($uu)){
            $_SESSION['inner_message']['error'][]='Name Already Exist.';
          header( 'Location:'.Doo::conf()->APP_URL.Doo::conf()->membermod.'productcategories/edit/'.$this->params[0]);
          echo('0');
        }else{
        $productcategories = Doo::loadModel('ProductCategories', true);
      ...
      $productcategories->ar_name=$_POST['ar_name'];
        ...
        $productcategories->edit_by=$_SESSION['member_username']['id'];

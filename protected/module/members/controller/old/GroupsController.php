 ...
 * @author darkredz
 */
class GroupsController extends MembersController{
    ...
    if(isset($_GET['load'])){
      ...
      foreach ($lists as $list) {
        $info['data'][]=array(
          ...
          "<div class='text-center'><a href='".Doo::conf()->APP_URL.Doo::conf()->membermod."groups/edit/".$list->id."' ><div  class='btn btn-warning'><i class='fa fa-cog'></i> Edit</div></a></div>"
          );
      }
    }else{
         $info['data'][]=array("","","","");
...
$arr=array(
    ...
    if(isset($arrview->actions)){
      ...
      if(!empty($uu)){
          ...
          header( 'Location:'.Doo::conf()->APP_URL.Doo::conf()->membermod.'groups/add/');
        }else{
        ...
        $group->create_by=$_SESSION['member_username']['id'];
        $group->edit_by=$_SESSION['member_username']['id'];
        
        $lastinserted=$this->db()->insert($group);
        
        if(!empty($lastinserted)){
            
            $permission =Doo::loadModel('Permissions', true);$permission->group_id=$lastinserted;$permission->controller_name='MainController';$permission->actions='index,login,logout';$permission->create_date=date('Y-m-d H:m:s');$permission->edit_date=date('Y-m-d H:m:s');$permission->create_by=$_SESSION['member_username']['id'];$this->db()->insert($permission);
            ...
            $permission =Doo::loadModel('Permissions', true);$permission->group_id=$lastinserted;$permission->controller_name='ArticlesController';$permission->actions=$rights;$permission->create_date=date('Y-m-d H:m:s');$permission->edit_date=date('Y-m-d H:m:s');$permission->create_by=$_SESSION['member_username']['id'];$this->db()->insert($permission);     
            $permission =Doo::loadModel('Permissions', true);$permission->group_id=$lastinserted;$permission->controller_name='ServicesController';$permission->actions=$rights;$permission->create_date=date('Y-m-d H:m:s');$permission->edit_date=date('Y-m-d H:m:s');$permission->create_by=$_SESSION['member_username']['id'];$this->db()->insert($permission);     
            ...
            $permission =Doo::loadModel('Permissions', true);$permission->group_id=$lastinserted;$permission->controller_name='PhotosController';$permission->actions=$rights;$permission->create_date=date('Y-m-d H:m:s');$permission->edit_date=date('Y-m-d H:m:s');$permission->create_by=$_SESSION['member_username']['id'];$this->db()->insert($permission);     
            ...
            $permission =Doo::loadModel('Permissions', true);$permission->group_id=$lastinserted;$permission->controller_name='ContactController';$permission->actions=$rights;$permission->create_date=date('Y-m-d H:m:s');$permission->edit_date=date('Y-m-d H:m:s');$permission->create_by=$_SESSION['member_username']['id'];$this->db()->insert($permission);     
            $permission =Doo::loadModel('Permissions', true);$permission->group_id=$lastinserted;$permission->controller_name='InspactionController';$permission->actions=$rights;$permission->create_date=date('Y-m-d H:m:s');$permission->edit_date=date('Y-m-d H:m:s');$permission->create_by=$_SESSION['member_username']['id'];$this->db()->insert($permission);     
            ...
            $permission =Doo::loadModel('Permissions', true);$permission->group_id=$lastinserted;$permission->controller_name='MaillistController';$permission->actions=$rights;$permission->create_date=date('Y-m-d H:m:s');$permission->edit_date=date('Y-m-d H:m:s');$permission->create_by=$_SESSION['member_username']['id'];$this->db()->insert($permission);     
            ...
            $permission =Doo::loadModel('Permissions', true);$permission->group_id=$lastinserted;$permission->controller_name='UsersController';$permission->actions=$rights;$permission->create_date=date('Y-m-d H:m:s');$permission->edit_date=date('Y-m-d H:m:s');$permission->create_by=$_SESSION['member_username']['id'];$this->db()->insert($permission);
            ...
            $permission =Doo::loadModel('Permissions', true);$permission->group_id=$lastinserted;$permission->controller_name='GroupsController';$permission->actions=$rights;$permission->create_date=date('Y-m-d H:m:s');$permission->edit_date=date('Y-m-d H:m:s');$permission->create_by=$_SESSION['member_username']['id'];$this->db()->insert($permission);     
            ...
            $permission =Doo::loadModel('Permissions', true);$permission->group_id=$lastinserted;$permission->controller_name='ClientsController';$permission->actions=$rights;$permission->create_date=date('Y-m-d H:m:s');$permission->edit_date=date('Y-m-d H:m:s');$permission->create_by=$_SESSION['member_username']['id'];$this->db()->insert($permission);     
            ...
            if(isset($_POST['suppliers_view'])){$rights.='index,';}
             ...
             $permission =Doo::loadModel('Permissions', true);$permission->group_id=$lastinserted;$permission->controller_name='SuppliersController';$permission->actions=$rights;$permission->create_date=date('Y-m-d H:m:s');$permission->edit_date=date('Y-m-d H:m:s');$permission->create_by=$_SESSION['member_username']['id'];$this->db()->insert($permission);     
           ...
           $rights='';
            if(isset($_POST['otherbanks_view'])){$rights.='index,';}
             ...
             $permission =Doo::loadModel('Permissions', true);$permission->group_id=$lastinserted;$permission->controller_name='OtherbanksController';$permission->actions=$rights;$permission->create_date=date('Y-m-d H:m:s');$permission->edit_date=date('Y-m-d H:m:s');$permission->create_by=$_SESSION['member_username']['id'];$this->db()->insert($permission);     
            ...
            $rights='';
             ...
             $permission =Doo::loadModel('Permissions', true);$permission->group_id=$lastinserted;$permission->controller_name='CategoriesController';$permission->actions=$rights;$permission->create_date=date('Y-m-d H:m:s');$permission->edit_date=date('Y-m-d H:m:s');$permission->create_by=$_SESSION['member_username']['id'];$this->db()->insert($permission);     
            ...
            $rights='';
             ...
             $permission =Doo::loadModel('Permissions', true);$permission->group_id=$lastinserted;$permission->controller_name='StockroomsController';$permission->actions=$rights;$permission->create_date=date('Y-m-d H:m:s');$permission->edit_date=date('Y-m-d H:m:s');$permission->create_by=$_SESSION['member_username']['id'];$this->db()->insert($permission);     
            ...
            $permission =Doo::loadModel('Permissions', true);$permission->group_id=$lastinserted;$permission->controller_name='ItemsController';$permission->actions=$rights;$permission->create_date=date('Y-m-d H:m:s');$permission->edit_date=date('Y-m-d H:m:s');$permission->create_by=$_SESSION['member_username']['id'];$this->db()->insert($permission);     
            ...
            $permission =Doo::loadModel('Permissions', true);$permission->group_id=$lastinserted;$permission->controller_name='StoresController';$permission->actions=$rights;$permission->create_date=date('Y-m-d H:m:s');$permission->edit_date=date('Y-m-d H:m:s');$permission->create_by=$_SESSION['member_username']['id'];$this->db()->insert($permission);
            ...
            $permission =Doo::loadModel('Permissions', true);$permission->group_id=$lastinserted;$permission->controller_name='StockallocationsController';$permission->actions=$rights;$permission->create_date=date('Y-m-d H:m:s');$permission->edit_date=date('Y-m-d H:m:s');$permission->create_by=$_SESSION['member_username']['id'];$this->db()->insert($permission);     
            ...
            $permission =Doo::loadModel('Permissions', true);$permission->group_id=$lastinserted;$permission->controller_name='GoodController';$permission->actions=$rights;$permission->create_date=date('Y-m-d H:m:s');$permission->edit_date=date('Y-m-d H:m:s');$permission->create_by=$_SESSION['member_username']['id'];$this->db()->insert($permission);     
            ...
            $permission =Doo::loadModel('Permissions', true);$permission->group_id=$lastinserted;$permission->controller_name='ExpensesController';$permission->actions=$rights;$permission->create_date=date('Y-m-d H:m:s');$permission->edit_date=date('Y-m-d H:m:s');$permission->create_by=$_SESSION['member_username']['id'];$this->db()->insert($permission);     
            ...
            $permission =Doo::loadModel('Permissions', true);$permission->group_id=$lastinserted;$permission->controller_name='BanksController';$permission->actions=$rights;$permission->create_date=date('Y-m-d H:m:s');$permission->edit_date=date('Y-m-d H:m:s');$permission->create_by=$_SESSION['member_username']['id'];$this->db()->insert($permission);     
            ...
            $permission =Doo::loadModel('Permissions', true);$permission->group_id=$lastinserted;$permission->controller_name='PaymentsController';$permission->actions=$rights;$permission->create_date=date('Y-m-d H:m:s');$permission->edit_date=date('Y-m-d H:m:s');$permission->create_by=$_SESSION['member_username']['id'];$this->db()->insert($permission);     
            ...
            if(isset($_POST['purchases_view'])){$rights.='index,getnames,getnumber,details,';}
             ...
             $permission =Doo::loadModel('Permissions', true);$permission->group_id=$lastinserted;$permission->controller_name='PurchasesController';$permission->actions=$rights;$permission->create_date=date('Y-m-d H:m:s');$permission->edit_date=date('Y-m-d H:m:s');$permission->create_by=$_SESSION['member_username']['id'];$this->db()->insert($permission);        
            ...
            if(isset($_POST['workorders_view'])){$rights.='index,details,';}
             ...
             $permission =Doo::loadModel('Permissions', true);$permission->group_id=$lastinserted;$permission->controller_name='WorkordersController';$permission->actions=$rights;$permission->create_date=date('Y-m-d H:m:s');$permission->edit_date=date('Y-m-d H:m:s');$permission->create_by=$_SESSION['member_username']['id'];$this->db()->insert($permission);        
            ...
            if(isset($_POST['certificates_view'])){$rights.='index,getitems,details,getaddress,';}
             ...
             $permission =Doo::loadModel('Permissions', true);$permission->group_id=$lastinserted;$permission->controller_name='CertificatesController';$permission->actions=$rights;$permission->create_date=date('Y-m-d H:m:s');$permission->edit_date=date('Y-m-d H:m:s');$permission->create_by=$_SESSION['member_username']['id'];$this->db()->insert($permission);        
            ...
            if(isset($_POST['delivery_view'])){$rights.='index,getitems,details,';}
             ...
             $permission =Doo::loadModel('Permissions', true);$permission->group_id=$lastinserted;$permission->controller_name='DeliveryController';$permission->actions=$rights;$permission->create_date=date('Y-m-d H:m:s');$permission->edit_date=date('Y-m-d H:m:s');$permission->create_by=$_SESSION['member_username']['id'];$this->db()->insert($permission);        
            ...
            if(isset($_POST['quotations_view'])){$rights.='index,details,';}
             ...
             $permission =Doo::loadModel('Permissions', true);$permission->group_id=$lastinserted;$permission->controller_name='QuotationsController';$permission->actions=$rights;$permission->create_date=date('Y-m-d H:m:s');$permission->edit_date=date('Y-m-d H:m:s');$permission->create_by=$_SESSION['member_username']['id'];$this->db()->insert($permission);        
            ...
            $permission =Doo::loadModel('Permissions', true);$permission->group_id=$lastinserted;$permission->controller_name='ReportsController';$permission->actions=$rights;$permission->create_date=date('Y-m-d H:m:s');$permission->edit_date=date('Y-m-d H:m:s');$permission->create_by=$_SESSION['member_username']['id'];$this->db()->insert($permission);     
            ...
            if(isset($_POST['prefrances_view'])){$rights.='index,';}
             ...
             if(isset($_POST['prefrances_delete'])){$rights.='delete,';}
              $permission =Doo::loadModel('Permissions', true);$permission->group_id=$lastinserted;$permission->controller_name='PrefrancesController';$permission->actions=$rights;$permission->create_date=date('Y-m-d H:m:s');$permission->edit_date=date('Y-m-d H:m:s');$permission->create_by=$_SESSION['member_username']['id'];$this->db()->insert($permission);     
              $rights='';
            ...
            $permission =Doo::loadModel('Permissions', true);$permission->group_id=$lastinserted;$permission->controller_name='SearchesController';$permission->actions=$rights;$permission->create_date=date('Y-m-d H:m:s');$permission->edit_date=date('Y-m-d H:m:s');$permission->create_by=$_SESSION['member_username']['id'];$this->db()->insert($permission);     
            ...
            $permission =Doo::loadModel('Permissions', true);$permission->group_id=$lastinserted;$permission->controller_name='InvoicesController';$permission->actions=$rights;$permission->create_date=date('Y-m-d H:m:s');$permission->edit_date=date('Y-m-d H:m:s');$permission->create_by=$_SESSION['member_username']['id'];$this->db()->insert($permission);     
   
   
            $_SESSION['inner_message']['success'][]='Data Added Successfully';
            header( 'Location:'.Doo::conf()->APP_URL.Doo::conf()->membermod.'groups' );           
...
public function update(){
      ...
      if(!empty($uu)){
          $_SESSION['inner_message']['error'][]='Name Already Exist.';
          header( 'Location:'.Doo::conf()->APP_URL.Doo::conf()->membermod.'groups/edit/'.$this->params[0]);
        }else{

...
<div class="span-23 last" style="padding-top:10px;text-align:left;font-size:20px;">
    ...
    <a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>clients/add" class="link">
        <h4 style="margin:0px;">
...
<table id="myTable" class="tablesorter"> 
            ...
            <tbody> 
                ...
                <tr class="table-row<?php echo $x%2; ?>">
                    <td>
                        <a id="del_<?php echo $client->id; ?>"  href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>clients/delete/<?php echo $client->id; ?>" class="delet">
                    ...
                    <td>
                        <a  href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>clients/edit/<?php echo $client->id; ?>" class="link">

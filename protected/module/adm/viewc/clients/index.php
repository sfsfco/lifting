        ...
        $(document).ready(function() {
            ...
            var table = $('#datatable-info').DataTable({
                                ...
                                $('.activate').click(function(event) {
                                    item = $(this);
                                    $.ajax({url: "<?php echo Doo::conf()->APP_URL.Doo::conf()->adminmod; ?>clients/activate/"+item.attr('icon-val'), success: function(result){
                                        if(result=='0'){
                ...
                "serverSide":true,
                "ajax": {
                    url:"<?php echo Doo::conf()->APP_URL.Doo::conf()->adminmod; ?>clients/index/?load=1",
                    type:"post",
                    },
                select: true,
                "order": [[ 0, 'desc' ]],
                ...
                buttons: [
                    {
                        ...
                        action: function ( e, dt, node, config ) {
                            window.location.href = "<?php echo Doo::conf()->APP_URL.Doo::conf()->adminmod; ?>clients/add";
                        },
                        className:'add-blue'
                    },
                    'pageLength',

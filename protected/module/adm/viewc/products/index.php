            ...
            var table = $('#datatable-info').DataTable({
                                "initComplete": function(settings, json) {
                                    ...
                                    $('.featured').click(function(event) {
                                        item = $(this);
                                        $.ajax({url: "<?php echo Doo::conf()->APP_URL.Doo::conf()->adminmod; ?>products/featured/"+item.attr('icon-val'), success: function(result){
                                            if(result=='0'){
                ...
                "serverSide":true,
                "ajax": {
                    url:"<?php echo Doo::conf()->APP_URL.Doo::conf()->adminmod; ?>products/index/?load=1",
                    type:"post",
                    },
                select: true,
                "order": [[ 0, 'desc' ]],
                ...
                buttons: [
                    {
                        ...
                        action: function ( e, dt, node, config ) {
                            window.location.href = "<?php echo Doo::conf()->APP_URL.Doo::conf()->adminmod; ?>products/add";
                        },
                        className:'add-blue'
                    },
                    'pageLength',

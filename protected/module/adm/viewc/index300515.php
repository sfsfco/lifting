...
<html>
    ...
    <link rel="stylesheet" type="text/css" href="<?php  echo $data['rootUrl']; ?>global/css/adm/superfish.css" media="screen">
...
<!-- /TinyMCE -->
 ...
 $('.cert_type').change(function(){
  ...
  $.ajax({
        url: '<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>certificates/index/'+$(this).val(),
        cache: false,
...
$('textarea.tinymce').tinymce({
        ...
        $('#filter-stockroom').change(function(){
             $.ajax({
		  url: '<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>stores/filter/'+$(this).val(),
		  cache: false,
		  success: function(html){
		  	$(".place").html(html);
		  	beready();
        ...
        $('#payment_for2').change(function(){
            $.ajax({
		  url: '<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>returned/getpaymentid/'+$(this).val()+'/'+ $('#payment_type').val(),
		  cache: false,
		  success: function(html){
        ...
        $('#payment_id2').change(function(){
            $.ajax({
		  url: '<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>returned/getpaymentdetails/'+$(this).val(),
		  cache: false,
		  success: function(html){
        ...
        $('#payment_for1').change(function(){
            $.ajax({
		  url: '<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>payments/getpaymentid1/'+$(this).val()+'/'+ $('#payment_type1').val(),
		  cache: false,
        ...
        $.ajax({
		  url: '<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>payments/paymenttype1/'+$(this).val(),
		  cache: false,
        ...
        $('#payment_for').change(function(){
            $.ajax({
		  url: '<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>payments/getpaymentid/'+$(this).val()+'/'+ $('#payment_type').val(),
		  cache: false,
		  success: function(html){
        ...
        $.ajax({
		  url: '<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>payments/paymenttype/'+$(this).val(),
		  cache: false,
		  success: function(html){
    ...
    $('#username').keyup(function(){
         ...
         $.ajax({
		  url: "<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>users/checkusername/"+$(this).val(), 
		  cache: false,
		  success: function(html){
...
///search
 $(".search-button").click(function(){
           ...
           $(".place").html('<div style="padding-top:30px;width:100%;text-align:center;background:#FFF"><img src="<?php  echo $data['rootUrl']; ?>global/img/ajax-13.gif" /></div>');
            setTimeout(function(){
            $.ajax({
		  url:'<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>searches/find/', 
		  cache: false,
          type:'post',
          data:$values,
		  success: function(html){
		...
		(
			{
				...
				success: function (data, status)
				{
					if(typeof(data.error) != 'undefined')
					{
						...
						{
							alert('Upload done');
							$('.'+place).html("<img src='<?php  echo $data['rootUrl']; ?>global/uploads/"+type+"/"+data.msg+"' style='width:100px;'>");
	...
	<body>
     ...
     <div class="span-16 ">
        <div style="float:left;text-align:center;">
            <a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>"><img class="site-logo"  src="<?php  echo $data['rootUrl']; ?>global/uploads/<?php echo $data['prefrances']->logo; ?>" ></a>
      ...
      <div class="span-24 last" style="direction:ltr">
        ...
        &nbsp;&nbsp;|&nbsp;&nbsp;<a  href="<?php echo $data['rootUrl'] ?>" target="_blank"><strong><img src="<?php echo $data['rootUrl']; ?>global/img/eye.png"> Preview</strong></a>
        &nbsp;&nbsp;|&nbsp;&nbsp;<a  href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>users/edit/<?php echo  $_SESSION['username']['id']; ?>" class="link">My Account </a>
        &nbsp;&nbsp;|&nbsp;&nbsp;<a  href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>users/editpass/<?php echo $_SESSION['username']['id']; ?>" class="link">Change Password</a>
        &nbsp;&nbsp;|&nbsp;&nbsp;<a href="<?php echo $data['formUrl']; ?><?php echo Doo::conf()->adminmod; ?>main/logout"><span style="color:red">Logout</span></a> 
        <img src="<?php  echo $data['rootUrl']; ?>global/img/icons/out.png">
      </div>
      <div class="span-24 last">
        <div class="borderhard" style="margin-top:30px;text-align:center;">
            		<ul class="sf-menu">
                        <li class="last"><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>searches">Search<img src="<?php  echo $data['rootUrl']; ?>global/img/icons/search.png"></a></li>
						<li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>prefrances" >Prefrances<img src="<?php  echo $data['rootUrl']; ?>global/img/icons/prefrance.png"></a></li>
                        <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>reports">Reports<img src="<?php  echo $data['rootUrl']; ?>global/img/icons/report.png"></a></li>
                        <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>quotations">Quotations <img src="<?php  echo $data['rootUrl']; ?>global/img/icons/daily.png"></a></li>
                        <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>workorders">Work Orders <img src="<?php  echo $data['rootUrl']; ?>global/img/icons/daily.png"></a>
                        <ul>
                            <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>workorders">Work Orders <img src="<?php  echo $data['rootUrl']; ?>global/img/icons/daily.png"></a></li>
                            <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>certificates">Certificates <img src="<?php  echo $data['rootUrl']; ?>global/img/icons/daily.png"></a></li>
                            <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>delivery">Delivery Note <img src="<?php  echo $data['rootUrl']; ?>global/img/icons/daily.png"></a></li>
                            
                        </ul>
                        </li>
                        <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>purchases">Purchases<img src="<?php  echo $data['rootUrl']; ?>global/img/icons/daily.png"></a></li>
                        <!--
                        <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>returned">Refund<img src="<?php  echo $data['rootUrl']; ?>global/img/icons/daily.png"></a></li>
                        -->
                        <li>Accounts<img  src="<?php  echo $data['rootUrl']; ?>global/img/icons/daily.png">
                            <ul>
                                <!--<li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>expenses">Expenses</a></li>-->
                                <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>banks">Our Bank Accounts</a></li>
                                <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>invoices">Invoices</a></li>
                                <!--<li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>payments/income">Income Check</a></li>
                                <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>payments/pay">Payment Check</a></li>-->
                            </ul>
                        </li>
                        <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>stockrooms">Stores<img src="<?php  echo $data['rootUrl']; ?>global/img/icons/item.png"></a>
                        <ul>
                                        <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>stockrooms">Stores</a></li>
                                        <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>items">Items</a></li>
                                        <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>stores">Stores Stock</a></li>
                                        <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>stockallocations">Stock Allocation</a></li>
                                        <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>good">Goods Receipts Note</a></li>
                                    </ul>
                        </li>
                        
                       
                        <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>users">Settings<img src="<?php  echo $data['rootUrl']; ?>global/img/icons/tool.png"></a>
                        <ul>
                            <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>users" >Users</a></li>
                            <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>groups" >Groups</a></li>
                            <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>clients">Clients</a></li>
                            <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>suppliers">Suppliers</a></li>
                            <!--<li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>towns">Towns</a></li>-->
                            <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>otherbanks">Banks</a></li>
                            <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>categories">Categories</a></li>
                        </ul>
                        </li>
                        <li class="first"><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>articles">CMS<img src="<?php  echo $data['rootUrl']; ?>global/img/icons/edit.png"></a>
                        <ul>
                            <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>articles">Articles</a></li>
                            <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>services">Services</a></li>
                            <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>photos">Photos</a></li>
                            <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>contact">Messages</a></li>
                            <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>inspaction">Inspections Request</a></li>
                            <li><a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>maillist">maillist</a></li>
                        </ul>
                        </li>
                    </ul>
        </div>
      ...
      <div class="span-24 last ">
        <div class="borderhard place" style="margin-top:30px;text-align:center;">
            ...
            <div class="span-5 divbox">
            	<a class="fastmenu" href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>prefrances" >
            ...
            <div class="span-5 divbox">
            	<a class="fastmenu" href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>sales">
            		<img width="64" src="<?php  echo $data['rootUrl']; ?>global/img/sales.png">
            		<div>Sales</div>
            	</a>
            </div>
            <div class="span-5 divbox">
            	<a class="fastmenu" href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>reports">
            		<img width="64" src="<?php  echo $data['rootUrl']; ?>global/img/reports.png">
            		<div>Reports</div>
            	</a>
            </div>
            <div class="span-5 divbox">
            	<a class="fastmenu" href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>stores">
            		<img width="64" src="<?php  echo $data['rootUrl']; ?>global/img/store.png">
            		<div>Stores</div>
            	</a>
            </div>
            <div class="span-4 last divbox">
            	<a class="fastmenu" href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>users" >

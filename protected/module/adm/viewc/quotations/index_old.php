...
<div class="span-23 last" style="padding-top:10px;text-align:left;font-size:20px;">
    ...
    <a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>quotations/add" class="link">
        <h4 style="margin:0px;">
            ...
            <tbody> 
                ...
                <tr class="table-row<?php echo $x%2; ?> <?php if($quotation->has_workorder=='1'){echo("coverted");}?>" >
                     ...
                     <?php if($quotation->has_workorder=='0'){ ?>
                        <a id="del_<?php echo $quotation->id; ?>"    href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>quotations/delete/<?php echo $quotation->id; ?>" class="delet">
                     ...
                     <td>
                     <?php if($quotation->has_workorder=='0'){ ?>
                        <a  href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>quotations/convert/<?php echo $quotation->id; ?>" class="link">
                            <img src="<?php  echo $data['rootUrl']; ?>global/img/workorder.png">
                        </a>
                        <?php }else{echo('Converted');} ?>
                    </td>
                     <td>
                        <a  href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>quotations/details/<?php echo $quotation->id; ?>" class="link">
                            <img src="<?php  echo $data['rootUrl']; ?>global/img/details.png">
                        </a>
                    </td>
                    <td>
                       <a href="<?php echo $data['formUrl'] ?><?php echo Doo::conf()->adminmod; ?>quotations/send/<?php echo $quotation->id; ?>" class="link">
                    ...
                    <td><a href="<?php echo $data['formUrl']; ?><?php echo Doo::conf()->adminmod; ?>quotations/edit/<?php echo $quotation->id; ?>" class="link" ><?php echo $quotation->title; ?></a></td>

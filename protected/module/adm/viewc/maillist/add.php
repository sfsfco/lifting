			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="x_content">
						...
						<form class="form-horizontal form-label-left"  method="post" action="<?php echo Doo::conf()->APP_URL.Doo::conf()->adminmod; ?>maillist/insert"  novalidate>
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
		                          ...
		                          <select class="select2_multiple form-control" multiple="multiple" id="to" name="to[]">
		                            
		                              <option value="all">All</option>
		                            
		                            <?php foreach($data['mails'] as $mails){ ?>
							        	<option value="<?php echo $mails->id; ?>"><?php echo $mails->name." : ".$mails->email; ?></option>
							        <?php }?>

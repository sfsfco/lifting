                  ...
                  <div class="bs-example" data-example-id="simple-jumbotron">
					...
					<div class="form-group">
						<div class="col-md-12 text-right">
							<a href="<?php echo Doo::conf()->APP_URL.Doo::conf()->adminmod; ?>contact/add/<?php echo $data['contact']->email; ?>/<?php echo $data['contact']->subject; ?>" class="btn btn-success">Replay</a>
						</div>
					</div>
                </div>
              </div>

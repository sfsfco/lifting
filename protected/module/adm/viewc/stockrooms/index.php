...
<script>
        ...
        $(document).ready(function() {
            ...
            var table = $('#datatable-info').DataTable({
                ...
                "serverSide":true,
                "ajax": {
                    url:"<?php echo Doo::conf()->APP_URL.Doo::conf()->adminmod; ?>stockrooms/index/?load=1",
                    type:"post",
                    },
                select: true,
                "order": [[ 0, 'desc' ]],
                ...
                buttons: [
                    {
                        ...
                        action: function ( e, dt, node, config ) {
                            window.location.href = "<?php echo Doo::conf()->APP_URL.Doo::conf()->adminmod; ?>stockrooms/add";
                        },
                        className:'add-blue'
                    },
                    'pageLength',

            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left"  method="post" action="<?php echo Doo::conf()->APP_URL.Doo::conf()->adminmod; ?>stockallocations/insert"  novalidate>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="client" class="form-control col-md-7 col-xs-12" disabled="disabled" name="client" type="text" value="">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="delivery" class="form-control col-md-7 col-xs-12" name="delivery" required="required" type="text" disabled="disabled" value="">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input class="form-control col-md-7 col-xs-12" disabled="disabled" name="total_value" id="total_value" value="" type="text" >
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="options-table col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="first options-table-item col-md-12 col-sm-12 col-xs-12">
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <select  name="item_0" id="item_0" onchange="get_items(this)" class="select2_group form-control" >
                                        ...
                                        <div class="col-md-2 col-sm-2 col-xs-12">
                                            <input name="quantity_0" id="quantity_0" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="1" placeholder="quantity" required="required" type="text"  onchange="total(this);" value="">
                                        </div>
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <textarea name="details_0" id="details_0" class="form-control"></textarea>
                                        </div>
                                        <div class="col-md-2 col-sm-2 col-xs-12">
                                            <input id="unit_cost_0" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="1" name="unit_cost_0" placeholder="" required="required" type="text" value="">
                                        </div>
                                        <div class="col-md-2 col-sm-2 col-xs-12">
                                            <input id="total_0" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="1" name="total_0" placeholder="" required="required" type="text" value="">
                                        </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="percentage_profit" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="1" name="percentage_profit" placeholder="" required="required" type="text" value="">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="cost_value" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="1" name="cost_value" placeholder="" required="required" type="text" value="">
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    function get_stock_itmes(v){
     $.ajax({
          url: '<?php echo Doo::conf()->APP_URL.Doo::conf()->adminmod; ?>stockallocations/getitems/'+v, 
          cache: false,
    ...
    function get_items(v){
         $.ajax({
          url: '<?php echo Doo::conf()->APP_URL.Doo::conf()->adminmod; ?>stockallocations/get_items/'+v.value, 
          cache: false,
          success: function(html){

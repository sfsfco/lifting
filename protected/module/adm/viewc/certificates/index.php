...
<script>
        ...
        $(document).ready(function() {
            ...
            var table = $('#datatable-info').DataTable({
                ...
                "serverSide":true,
                "ajax": {
                    url:"<?php echo Doo::conf()->APP_URL.Doo::conf()->adminmod; ?>certificates/index/?load=1",
                    type:"post",
                    },
                select: true,
                "order": [[ 0, 'desc' ]],
                ...
                lengthMenu: [
                    [ 10, 25, 50, 200 ],
                    [ '10 rows', '25 rows', '50 rows' ,'200 rows' ]
                ],
                buttons: [
                {
                        text: '<i class="fa fa-plus-circle"></i> ADD NEW',
                        action: function ( e, dt, node, config ) {
                            window.location.href = "<?php echo Doo::conf()->APP_URL.Doo::conf()->adminmod; ?>certificates/add";
                        },
                        className:'add-blue'
                    },
                    'pageLength',

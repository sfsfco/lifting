 ...
 <body>
    <div class="container printable">
        ...
        <!--start print-->
            ...
            <div class="span-20 last" style="padding-top:30px;">AUTHORISED SIGNATURE……….....................<?php if(isset($_SESSION['username']['sign'])){ ?><img src="<?php  echo $data['rootUrl']; ?>global/uploads/users/<?php echo $_SESSION['username']['sign']; ?>" style="width: 150px;position: absolute;margin-top: -20px;margin-left: -75px;"><?php } ?>......................</div>

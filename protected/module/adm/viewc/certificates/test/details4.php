 ...
 <body>
    <div class="container showgrid">
        ...
        <!--start print-->
            ...
            <div class="span-20 last" style="padding-top:40px;">AUTHORISED SIGNATURE………..................<?php if(isset($_SESSION['username']['sign'])){ ?><img src="<?php  echo $data['rootUrl']; ?>global/uploads/users/<?php echo $_SESSION['username']['sign']; ?>" style="width: 150px;position: absolute;margin-top: -20px;margin-left: -75px;"><?php } ?>.........................  <img style="position: absolute;right: 120px;margin-top: -56px;height:105px;" src="<?php echo $data['rootUrl']; ?>global/images/stamp.png"></div>

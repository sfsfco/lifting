 ...
 <body>
    <div class="container showgrid">
        ...
        <!--start print-->
            ...
            <div class="span-20 last" style="padding-top:30px;">AUTHORISED SIGNATURE………..................<?php if(isset($_SESSION['username']['sign'])){ ?><img src="<?php  echo $data['rootUrl']; ?>global/uploads/users/<?php echo $_SESSION['username']['sign']; ?>" style="width:100px;"><?php } ?>.........................</div>

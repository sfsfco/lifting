            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left"  method="post" action="<?php echo Doo::conf()->APP_URL.Doo::conf()->adminmod; ?>certificates/insert"  novalidate>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select name="workorder" onchange="getitmes(this.value)" id="workorder" class="select2_group form-control">
                                        ...
                                        <?php foreach($data['workorders'] as $workorder){ ?>
                                            <option value="<?php echo $workorder->id; ?>" <?php echo($data['workorder']==$workorder->id)?"selected='selected'":""; ?>>
...
function getaddress(v){
     $.ajax({
      url: '<?php echo Doo::conf()->APP_URL.Doo::conf()->adminmod; ?>certificates/getaddress/'+v, 
      cache: false,
...
function getitmes(v){
     $.ajax({
      url: '<?php echo Doo::conf()->APP_URL.Doo::conf()->adminmod; ?>certificates/getitems/'+v+'/add', 
      cache: false,
      success: function(html){
...
function get_totales(){
    ...
    if(<?php echo $data['workorder']; ?> != '0'){
        getitmes('<?php echo $data['workorder']; ?>');
    }

...
class ContactController extends CoreController{
    ...
    if(isset($_GET['load'])){
      ...
      foreach ($lists as $list) {
        ...
        $info['data'][]=array(
          ...
          "<div class='text-center ".$myclass."'><a href='".Doo::conf()->APP_URL.Doo::conf()->adminmod."contact/read/".$list->id."' ><div  class='btn btn-warning'><i class='fa fa-folder-open-o'></i> Read</div></a></div>"
          );
      }
    }else{
         $info['data'][]=array(
 ...
 $_SESSION['inner_message']['success'][]='Message Sent Successfully';
        header( 'Location:'.Doo::conf()->APP_URL.Doo::conf()->adminmod.'contact' );

...
class ArticlesController extends CoreController{
    ...
    if(isset($_GET['load'])){
      ...
      foreach ($articles as $article) {
        ...
        $info['data'][]=array(
          ...
          "<div class='text-center'><a href='".Doo::conf()->APP_URL.Doo::conf()->adminmod."articles/edit/".$article->id."' ><div  class='btn btn-warning'><i class='fa fa-cog'></i> Edit</div></a></div>"
          );
      }
    ...
    $data['title']='Add Article';
      ...
      if(!empty($uu)){
       ...
       header( 'Location:'.Doo::conf()->APP_URL.Doo::conf()->adminmod.'articles/add/');
        }else{
        ...
        header( 'Location:'.Doo::conf()->APP_URL.Doo::conf()->adminmod.'articles' );
          }
  ...
  public function edit(){
    ...
    public function update(){
      ...
      if(!empty($uu)){
       $_SESSION['inner_message']['error'][]='Name Already Exist.';
       header( 'Location:'.Doo::conf()->APP_URL.Doo::conf()->adminmod.'articles/edit/'.$this->params[0]);
        }else{
        $lines = Doo::loadModel('Articles', true);

    ...
    if(isset($_GET['load'])){
          ...
          foreach ($lists as $list) {
            ...
            $info['data'][]=array(
              ...
              $list->received,
              $list->by,
              "<a href='".Doo::conf()->APP_URL.Doo::conf()->adminmod."purchases/details/".$list->id."' ><div  class='btn btn-info'><i class='fa fa-print'></i> Details</div></a> 
              "
              );
          }
        }else{
    ...
    foreach($_POST as $key=>$value){
      ...
      $purchases = Doo::loadModel('Purchases', true);
       ...
       $_SESSION['inner_message']['success'][]='Data Inserted Successfully';
          header( 'Location:'.Doo::conf()->APP_URL.Doo::conf()->adminmod.'purchases' );  

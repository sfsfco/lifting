 ...
 * @author darkredz
 */
class StockallocationsController extends CoreController{
    ...
    if(isset($_GET['load'])){
      ...
      foreach ($lists as $list) {
        ...
        $info['data'][]=array(
          ...
          "<div class='text-center'><a href='".Doo::conf()->APP_URL.Doo::conf()->adminmod."stockallocations/edit/".$list->id."' ><div  class='btn btn-warning'><i class='fa fa-cog'></i> Edit</div></a></div>"
          );
      }
    }else{
         $info['data'][]=array("","","","");
...
$this->renderc('stockallocations/index',$data);
    ...
    public function getitems(){
     ...
     public function insert(){
        ...
        $stock->create_by=$_SESSION['username']['id'];
              ...
              $nuu=0;
                ...
                for($x=0;$x<20;$x++){
                    if(isset($_POST['item_'.$x])){
                     ...
                     $stockallocationsdetails->create_by=$_SESSION['username']['id'];
    ...
    (isset($name->name))?$data['items'][$x]->name=$name->name:$data['items'][$x]->name='Deleted';
       ...
       public function update(){
        ...
        $stock->edit_by=$_SESSION['username']['id'];

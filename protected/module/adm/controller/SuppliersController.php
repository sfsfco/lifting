   ...
   if(isset($_GET['load'])){
      ...
      foreach ($lists as $list) {
        ...
        $info['data'][]=array(
          ...
          "<div class='text-center'><a href='".Doo::conf()->APP_URL.Doo::conf()->adminmod."suppliers/edit/".$list->id."' ><div  class='btn btn-warning'><i class='fa fa-cog'></i> Edit</div></a></div>"
          );
      }
    }else{
         $info['data'][]=array("","","","");
    ...
    public function add(){
      ...
      if(!empty($uu)){
          ...
          header( 'Location:'.Doo::conf()->APP_URL.Doo::conf()->adminmod.'suppliers/add/');
        }else{
        ...
        if(!empty($lastinserted)){
            ...
            header( 'Location:'.Doo::conf()->APP_URL.Doo::conf()->adminmod.'suppliers' );           
        }
          }
  ...
  public function edit(){
   $data['title']='Edit Supplier';
    ...
    public function update(){
      ...
      if(!empty($uu)){
          $_SESSION['inner_message']['error'][]='Name Already Exist.';
          header( 'Location:'.Doo::conf()->APP_URL.Doo::conf()->adminmod.'suppliers/edit/'.$this->params[0]);
        }else{
        $suppliers = Doo::loadModel('Suppliers', true);

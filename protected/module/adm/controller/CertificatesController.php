...
class CertificatesController extends CoreController{
  ...
  $data['rootUrl']=Doo::conf()->APP_URL;
    ...
    if(isset($_GET['load'])){
          ...
          if(isset($_POST['search']['value'])){
            $where="  certificate_form like '%".$_POST['search']['value']."%'  ||   certificat_type like '%".$_POST['search']['value']."%'  ||  workorder = '".$_POST['search']['value']."'  ||  id = '".$_POST['search']['value']."'  ";
          }else{
            $where=" id != '0' ";
          }
          ...
          (!isset($user->first_name))?$list->test_by=play::prefrances('site_name'):$list->test_by=$user->first_name." ".$user->last_name;
            ...
            $info['data'][]=array(
              ...
              <a href='".Doo::conf()->APP_URL.Doo::conf()->adminmod."certificates/edit/".$list->id."' ><div  class='btn btn-warning'><i class='fa fa-cog'></i> Edit</div></a> 
              <a href='".Doo::conf()->APP_URL.Doo::conf()->adminmod."certificates/send/".$list->id."' ><div  class='btn btn-success'><i class='fa fa-send'></i> Send</div></a>
              <a href='".Doo::conf()->APP_URL.Doo::conf()->adminmod."certificates/details/".$list->id."' ><div  class='btn btn-info'><i class='fa fa-print'></i> Details</div></a> 
              </div>"
              );
          }
        }else{
    ...
    public function add(){
        ...
        if(isset($this->params[0])){$data['workorder']=$this->params[0];}else{$data['workorder']='0';}
    ...
    public function insert_items(){
        ...
        $certificates->create_by=$_SESSION['username']['id'];
        $lastinserted=$this->db()->insert($certificates);
                     ...
                     $certificatesdetails->create_by=$_SESSION['username']['id'];
    ...
    public function insert(){
        ...
        $_SESSION['inner_message']['success'][]='Data Added Successfully';
            header( 'Location:'.Doo::conf()->APP_URL.Doo::conf()->adminmod.'certificates' ); 
        }
        }
     public function update(){
        ...
        $certificates->edit_by=$_SESSION['username']['id'];
              ...
              $nuu=0;
                ...
                for($x=0;$x<100;$x++){
                    ...
                    if(isset($_POST['id_'.$x])){
                     ...
                     $certificatesdetails->edit_by=$_SESSION['username']['id'];
                    $this->db()->insert($certificatesdetails);}
                    }

  ...
  if(isset($_GET['load'])){
      ...
      foreach ($lists as $list) {
        ...
        $info['data'][]=array(
          ...
          <!--<a href='".Doo::conf()->APP_URL.Doo::conf()->adminmod."delivery/edit/".$list->id."' ><div  class='btn btn-warning'><i class='fa fa-cog'></i> Edit</div></a>-->
          <a href='".Doo::conf()->APP_URL.Doo::conf()->adminmod."delivery/details/".$list->id."' ><div  class='btn btn-info'><i class='fa fa-print'></i> Details</div></a> 
          </div>"
          );
      }
    }else{
    ...
    public function getitems(){
     ...
     public function insert(){
        ...
        $delivery->create_by=$_SESSION['username']['id'];
        $lastinserted=$this->db()->insert($delivery);
              ...
              $nuu=0;
                ...
                for($x=0;$x<20;$x++){
                    if(isset($_POST['id_'.$x])){
                     ...
                     $deliverydetails->create_by=$_SESSION['username']['id'];
          ...
          header( 'Location:'.Doo::conf()->APP_URL.Doo::conf()->adminmod.'delivery' );  
        }

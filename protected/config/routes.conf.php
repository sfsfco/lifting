...
// my sout
$route['*']['/index.html'] = array('MainController', 'index');
$route['*']['/about_us'] = array('ArticlesController', 'about_us');
$route['*']['/site-map.html'] = array('ArticlesController', 'sitemap');
$route['*']['/our-services'] = array('ArticlesController', 'ourservices');
$route['*']['/contact'] = array('ContactController', 'index');
$route['*']['/gallery'] = array('GalleryController', 'index');
$route['*']['/terms'] = array('ArticlesController', 'terms');
$route['*']['/privacy-policy'] = array('ArticlesController', 'privacy');
$route['*']['/site-map'] = array('ArticlesController', 'sitemap');
// my rout


$route['*']['/adm'] = array('[adm]MainController', 'index');
$route['*']['/members'] = array('[members]MainController', 'index');
//$route['*']['/error'] = array('ErrorController', 'index');
$route['*']['/error'] = array('MainController', 'error');

//$route['*']['/sync'] = array('MainController', 'sync');

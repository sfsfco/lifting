        ...
        <section class="fproducts">
            ...
            <?php } ?>
                <div class="three columns">
                    <a href="<?php echo Doo::conf()->SITE_PATH ?>products/view/<?php echo $product->id; ?>"><img src="<?php echo Doo::conf()->APP_URL; ?>global/uploads/products/300X300_<?php echo end(explode(',', $product->photo)); ?>.jpg" alt="" /></a>
                    <a href="<?php echo Doo::conf()->SITE_PATH ?>products/view/<?php echo $product->id; ?>" class="text-center"><?php echo $product->name; ?></a>
                </div>

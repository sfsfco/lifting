 ...
 <body>
    <div class="container showgrid">
        ...
        <!--start print-->
            ...
            <div class="span-10" style="height:35px">CERTIFICATION NO: <b><?php echo $data['a7a']->id; ?></b></div><div class="span-10 last" style="height:35px">TESTER/EXAMINER: ENG. <b><?php echo $data['user']->first_name.' '.$data['user']->last_name;?></b></div>
            <div class="span-10" style="height:35px">QUALIFICATION: <b>ASNT LEVEL TWO </b></div><div class="span-10 last" style="height:35px">DATE OF TEST/EXAMINATION: <b><?php echo date('d-m-Y',strtotime($data['a7a']->test_date));  ?></b></div>
            <div class="span-10" >TYPE OF CERTIFICATE: <b>EC DECLARATION OF CONFORMITY</b> </div><div class="span-10 last" >TESTED ACCORDING TO <b><?php echo $data['a7a']->according_to; ?></b></div>
            <div class="span-20 last center">
                <table class="pclass">
                    <thead> 
                        <tr> 

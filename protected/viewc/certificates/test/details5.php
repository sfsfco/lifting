 ...
 <body>
    <div class="container showgrid">
        ...
        <!--start print-->
            ...
            <div class="span-10" >TYPE OF CERTIFICATE:  <b>VISUAL AND MPI CERTIFICATE</b> </div><div class="span-10 last" >TESTED ACCORDING TO <b><?php echo $data['a7a']->according_to; ?></b></div>
            <div class="span-20 last center">
                <table class="pclass">
                    <thead> 
                        <tr> 

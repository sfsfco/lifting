 ...
 <body>
    <div class="container showgrid">
        ...
        <!--start print-->
            ...
            <div class="span-10" style="height:20px">TYPE OF CERTIFICATE: LOAD TEST/ MPI  </div><div class="span-10 last" style="height:20px">TESTED ACCORDING TO <?php echo $data['a7a']->according_to; ?></div>
            <div class="span-20 last center">
                <table class="pclass">
                    <thead> 
                        <tr> 
            ...
            <div class="span-20 last ">
                <table class="pclass1">
                    ...
                    <tbody> 
                        ...
                        <tr>
                            <td>Specification: BS6072:1981</td><td>Contrast Media: NPT16 WHITE PAINT</td><td>Inspector: <?php echo $data['user']->first_name.' '.$data['user']->last_name;?></td>
                        </tr>
                         <tr>

    ...
    <div class="container showgrid">
        ...
        <!--start print-->
            ...
            <div class="span-20 last center" style="margin-bottom:10px;">
                <h2 style="padding-top: 20px;font-weight: bolder;">AND / OR TEST OF LIFTING APPLIANCE OR ACCESSORY</h2>
            ...
            <div class="span-10" style="height:20px">CERTIFICATION NO: <?php echo $data['a7a']->id; ?></div><div class="span-10 last" style="height:20px">TESTER/EXAMINER: ENG. <?php echo $data['user']->first_name.' '.$data['user']->last_name;?></div>
            <div class="span-10" style="height:20px">QUALIFICATION: ASNT LEVEL TWO </div><div class="span-10 last" style="height:20px">DATE OF TEST/EXAMINATION: <?php echo date('d-m-Y',strtotime($data['a7a']->test_date));  ?></div>
            <div class="span-10" style="height:20px">TYPE OF CERTIFICATE:  VISUAL AND MPI CERTIFICATE </div><div class="span-10 last" style="height:20px">TESTED ACCORDING TO <?php echo $data['a7a']->according_to; ?></div>
            <div class="span-20 last center">
                <table class="pclass">
                    <thead> 
                        <tr> 
            ...
            <div class="span-20 last ">
                <table class="pclass1">
                    ...
                    <tbody> 
                        ...
                        <tr>
                            <td>Specification: BS6072:1981</td><td>Contrast Media: NPT16 WHITE PAINT</td><td>Inspector: Saad Mohamed</td>
                        </tr>
                         <tr>

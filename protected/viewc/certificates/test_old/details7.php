 ...
 <body>
    <div class="container showgrid">
        ...
        <!--start print-->
            ...
            <div class="span-10" style="height:35px">CERTIFICATION NO: <?php echo $data['a7a']->id; ?></div><div class="span-10 last" style="height:35px">TESTER/EXAMINER: ENG. <?php echo $data['user']->first_name.' '.$data['user']->last_name;?></div>
            <div class="span-10" style="height:35px">QUALIFICATION: ASNT LEVEL TWO </div><div class="span-10 last" style="height:35px">DATE OF TEST/EXAMINATION: <?php echo date('d-m-Y',strtotime($data['a7a']->test_date));  ?></div>
            <div class="span-10" style="height:35px">TYPE OF CERTIFICATE: EC DECLARATION OF CONFORMITY </div><div class="span-10 last" style="height:35px">TESTED ACCORDING TO <?php echo $data['a7a']->according_to; ?></div>
            <div class="span-20 last center">
                <table class="pclass">
                    <thead> 
                        <tr> 

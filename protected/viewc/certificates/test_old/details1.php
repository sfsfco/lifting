 ...
 <body>
    <div class="container showgrid">
        ...
        <!--start print-->
            ...
            <div class="span-10" style="height:35px">TYPE OF CERTIFICATE: TEST CERTIFICATE </div><div class="span-10 last" style="height:35px">TESTED ACCORDING TO <?php echo $data['a7a']->according_to; ?></div>
            <div class="span-20 last center">
                <table class="pclass">
                    <thead> 
                        <tr> 
